...
try {
  self.workbox.v['workbox:cache-expiration:3.0.0-alpha.3'] = 1;
...
class CacheTimestampsModel {
  ...
  constructor(cacheName) {
    ...
    this._db = new DBWrapper_mjs.DBWrapper('workbox-cache-expiration', 1, {
      onupgradeneeded: evt => evt.target.result.createObjectStore(this._storeName, { keyPath: URL_KEY }).createIndex(TIMESTAMP_KEY, TIMESTAMP_KEY, { unique: false })
    });
  }
