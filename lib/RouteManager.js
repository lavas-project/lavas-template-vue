...
var RouteManager = function () {
    function RouteManager(core) {
        ...
        (0, _assign2.default)(this, {
            targetDir: (0, _path.join)(this.config.globals.rootDir, './.lavas'),
                ...
                return _regenerator2.default.wrap(function _callee5$(_context5) {
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                routesFilePath = (0, _path.join)(this.config.webpack.base.output.path, ROUTES_FILE);
                ...
                return _regenerator2.default.wrap(function _callee8$(_context8) {
                    while (1) {
                        switch (_context8.prev = _context8.next) {
                            case 0:
                                routesFilePath = (0, _path.join)(this.cwd, ROUTES_FILE);
                                _context8.t0 = JSON;
                                _context8.next = 4;
